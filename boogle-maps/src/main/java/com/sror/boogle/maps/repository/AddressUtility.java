...
public class AddressUtility {
    ...
    public static void insertBulkIntoRedis(AddressCoordinationFunction addressCoordinationFunction) {
        for (int i = 0; i < ADDRESSES.length; i++) {
            ...
            addressCoordinationFunction.run(COORDINATIONS[i], new Address(streetAndNumber, city, state, zip));
        }
    }

    private static final Coordination[] COORDINATIONS = {
            new Coordination(42.096298, -70.968498),
            new Coordination(42.121185, -71.030151),
            new Coordination(42.119202, -71.466270),
            new Coordination(42.098141, -71.056488),
            new Coordination(42.616550, -71.363342),
    };
